# RMS Clone — System Design

## 1) Overview
RMS Clone هو تطبيق Flutter لإدارة الحجوزات (Reservations) لشركة SAHL Group، يعمل على الويب والموبايل. الهدف هو بناء نظام قابل للتوسع بواجهة موحدة، مع فصل صارم بين واجهة المستخدم والمنطق والبيانات.
