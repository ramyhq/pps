app.modals.LookupModal=function(){var e,t,a,o,l={serviceMethod:null,title:app.localize("SelectAnItem"),loadOnStartup:!0,showFilter:!0,filterText:"",excludeCurrentUser:!1,pageSize:app.consts.grid.defaultPageSize,canSelect:function(e){return!0}};function n(){t.ajax.reload()}this.init=function(i){e=i,l=$.extend(l,e.getOptions().lookupOptions),a=e.getModal().find(".lookup-modal-table"),t=a.DataTable({paging:!0,serverSide:!0,processing:!0,lengthChange:!1,pageLength:l.pageSize,deferLoading:l.loadOnStartup?null:0,listAction:{ajaxFunction:l.serviceMethod,inputFilter:function(){return $.extend({filter:o.val(),excludeCurrentUser:l.excludeCurrentUser},e.getArgs().extraFilters)}},columnDefs:[{targets:0,data:null,orderable:!1,defaultContent:"",className:"text-center",rowAction:{element:$("<button/>").addClass("btn btn-icon btn-bg-light btn-active-color-primary btn-sm").attr("title",app.localize("Select")).append($("<i/>").addClass("la la-chevron-circle-right")).click((function(){var t,a;t=$(this).data(),(a=l.canSelect(t))&&(!0===a?(e.setResult(t),e.close()):a.then((function(a){a&&(e.setResult(t),e.close())})))}))}},{targets:1,data:"name"}]}),e.getModal().find(".lookup-filter-button").click((function(e){e.preventDefault(),n()})),e.getModal().find(".modal-body").keydown((function(e){13===e.which&&(e.preventDefault(),n())})),(o=e.getModal().find(".lookup-filter-text")).val(l.filterText)}},app.modals.LookupModal.create=function(e){return new app.ModalManager({viewUrl:abp.appPath+"App/Common/LookupModal",scriptUrl:abp.appPath+"view-resources/Areas/App/Views/Common/Modals/_LookupModal.js",modalClass:"LookupModal",lookupOptions:e})};
